...
<body class="from-10% via-30% to-90% mx-auto mt-10 max-w-2xl bg-white text-slate-700">
    <nav class="mb-8 flex justify-between items-center text-lg font-medium">
        ...
        <ul class="flex space-x-2 items-center">
            ...
            <li>
                <a href="{{ route('auth.create') }}" style="white-space: nowrap; display: flex; align-items: center;">
                    <svg xmlns="http://www.w3.org/2000/svg" height="16" width="18" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"/></svg>
                    <span class="ml-2">
                        @auth
            ...
            <li>
                <!-- Shopping cart link -->
                <a href="{{ route('cart.create') }}" style="white-space: nowrap; display: flex; align-items: center;">
