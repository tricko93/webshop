...
<div class="flex items-center border border-gray-300 rounded-2xl focus:border-none">
    <input type="text" class="ml-0.5 border-0 focus:outline-none flex-grow px-4 text-xs" name="search" placeholder="Search...">
    <button type="submit" class="ml-2 bg-white-500 text-white px-4 py-2 rounded">
